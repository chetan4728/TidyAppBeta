...
public class SearchHistroryAdapter extends BaseAdapter {

    Context context;
    ArrayList<ModelSearch> filterList;
    View view;

    public SearchHistroryAdapter(Context context, ArrayList<ModelSearch> filterList, View view)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LayoutInflater inflater = (LayoutInflater) context
            ...
            convertView = inflater.inflate(R.layout.search_histroy_layout, null);
