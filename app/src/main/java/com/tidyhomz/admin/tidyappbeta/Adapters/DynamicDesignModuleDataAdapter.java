...
public class DynamicDesignModuleDataAdapter extends BaseAdapter {

    private  Context context;
    private  ArrayList<DynamicDesignDataContentModel> Arraylist;


    public DynamicDesignModuleDataAdapter(Context context, ArrayList<DynamicDesignDataContentModel> Arraylist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final DynamicDesignDataContentModel Object = Arraylist.get(position);
        if(convertView==null) {
            LayoutInflater view = (LayoutInflater) context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
            convertView = view.inflate(R.layout.dynamic_layout_module_gridview, null);
        }
