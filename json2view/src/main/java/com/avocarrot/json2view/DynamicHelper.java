...
public class DynamicHelper {
    ...
    private static void applyScrollbars(View view, DynamicProperty dynProp) {
        if (view instanceof ScrollView) {
            switch (dynProp.type) {
                case BOOLEAN: {
                    ((ScrollView) view).setVerticalScrollBarEnabled(dynProp.getValueBoolean());
                }
                break;
            }
        }
